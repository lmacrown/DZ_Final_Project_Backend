...
import com.douzone.handler.AuthFailureHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		*/
		...
		.and()
			.formLogin() // 로그인 폼은
			.usernameParameter("worker_id")
            .passwordParameter("worker_pw")
			.loginPage("http://localhost:3000/login") // 해당 주소로 로그인 페이지를 호출한다.
		...
		.and()
		    ...
		    .logoutSuccessUrl("http://localhost:3000/login") // 성공시 리턴 URL
